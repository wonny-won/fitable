...
export default function ApplicationDetailUI(props:ApplicationDetailProps){
    return(
        ...
        <S.MiniSection>
            ...
            <S.FileInput type="file" onChange={props.uploadFile('applyFile')} isEdit={props.isEdit}/>
        </S.MiniSection>
        </S.Section>
        <S.SubmitBt isEdit={props.isEdit} onClick={props.onClickUpdateAppltData}>수정하기</S.SubmitBt>
        </>
    )
}